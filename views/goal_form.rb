class GoalForm
  ...
  def form_deposit
    loop do
      ...
      break unless @user_input.validate_user_data_input(field: 'name')
    end
  ...
  def form_create
    ...
    loop do
      ...
      break unless @user_input.validate_date_input(type: 'year')
    end
    year = @user_input.last_input.to_i
    loop do
      print 'Ingrese el plazo maximo de la meta (mes): '
      break unless @user_input.validate_date_input(type: 'month')
    end
    month = @user_input.last_input.to_i
    loop do
      print 'Ingrese el plazo maximo de la meta (dia): '
      break unless @user_input.validate_date_input(type: 'day')
    end
